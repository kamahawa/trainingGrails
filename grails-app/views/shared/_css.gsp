...
<link href="${resource(dir: 'css/shopCSS', file: 'bootstrap.min.css')}" rel="stylesheet" type="text/css">
...
<link href="${resource(dir: 'css/shopCSS/plugins/chosen', file: 'chosen.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/icheck/skins', file: 'all.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/datepicker', file: 'datepicker.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/timepicker', file: 'bootstrap-timepicker.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/validator', file: 'bootstrapValidator.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/summernote', file: 'summernote.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/markdown', file: 'bootstrap-markdown.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS/plugins/datatable/css', file: 'bootstrap.datatable.min.css')}" rel="stylesheet" type="text/css">
...
<link href="${resource(dir: 'css/shopCSS/plugins/font-awesome/css', file: 'font-awesome.min.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS', file: 'style.css')}" rel="stylesheet" type="text/css">
<link href="${resource(dir: 'css/shopCSS', file: 'style-responsive.css')}" rel="stylesheet" type="text/css">